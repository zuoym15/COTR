...
class Summ_writer(object):
    ...
    def summ_scalar(self, name, value):
        ...
        if not np.isnan(value):
            ...
            elif np.mod(self.global_step, self.scalar_freq)==0:
                self.writer.add_scalar(name, value, global_step=self.global_step)
    ...
    def summ_2d_traj_on_image(self, name, traj, H, W, traj_g=None, size=1.0, only_return=False, frame_id=None):
        # traj is B x S x 3
        ...
        traj_pix = traj[0].detach().cpu().numpy()
    ...
    def summ_seg(self, name, seg, only_return=False, frame_id=None, colormap='tab10', label_colors=None):
    ...
    def summ_soft_seg(self, name, seg, bev=False, max_along_y=False, only_return=False, frame_id=None, colormap='tab10', label_colors=None):
        if not self.save_this:
            return
    ...
    def summ_soft_seg_thr(self, name, seg_e_sig, thr=0.5, only_return=False, colormap='tab10', frame_id=None, label_colors=None):
